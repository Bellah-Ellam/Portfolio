...
import CV from "../../assets/CV-B-Ellam.pdf"
    ...
    <section className="about section" id="about">
        ...
        <div className="about__container container grid">
           ...
           <div className="about__data">
            ...
            websites that bring data to life.<br />Whether it's creating custom dashboards, 
            implementing predictive models, or optimizing website performance, 
            I thrive on solving complex problems and delivering measurable results.</p>
